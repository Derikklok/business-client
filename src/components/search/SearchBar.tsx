...
const SearchBar = ({ className }: SearchBarProps) => {
  ...
  return (
    <div ref={searchRef} className={cn('relative flex-1 max-w-md mx-4', className)}>
      <div className="relative">
        ...
        <input 
          ...
          className="w-full pl-10 pr-4 py-2.5 bg-white/10 border border-white/30 rounded-lg text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent backdrop-blur-sm transition-all"
        />
      </div>
            ...
            <div className="py-2">
              ...
              {searchResults.map((result, index) => (
                <button
                  ...
                  className={cn(
                    "w-full px-4 py-3 text-left transition-colors focus:outline-none border-b border-gray-100 last:border-b-0",
                    selectedIndex === index 
